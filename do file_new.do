...
// Add more socio-economic parameters
use "data with new controls.dta" 
xtset city time
reghdfe lnbphev l1.outaget lngdp lncp lnpop lngas lnpetrol lnroad lnbus lnedu , absorb(i.month i.city i.year) vce(cluster city)
reghdfe lnbev l1.outaget lngdp lncp lnpop lngas lnpetrol lnroad lnbus lnedu , absorb(i.month i.city i.year) vce(cluster city)
reghdfe lnphev l1.outaget lngdp lncp lnpop lngas lnpetrol lnroad lnbus lnedu , absorb(i.month i.city i.year) vce(cluster city)

// Exclusion of Data from Cities Significantly Affected by COVID-19
use "Exclusion of Data from Cities Significantly Affected by COVID-19.dta"
xtset city time
reghdfe lnbphev l1.outaget lngdp, absorb(i.month#i.city i.year#i.city) vce(cluster city)
reghdfe lnbev l1.outaget lngdp, absorb(i.month#i.city i.year#i.city) vce(cluster city)
reghdfe lnphev l1.outaget lngdp, absorb(i.month#i.city i.year#i.city) vce(cluster city)

//Questionaire for EV purchase intention
use "survey data1.dta"
reg intention power_outage_level income education charge_infra home_charging_concern public_perce road incentive environmental congestion public_trans low_carbon range_anxiety i.city,r
use "survey data2.dta"
reg intention power_outage_times income education charge_infra home_charging_concern public_perce road incentive environmental congestion public_trans low_carbon range_anxiety i.city,r
